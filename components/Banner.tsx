  ...
  return (
    ...
    lgl:gap-8 mdl:px-10 xl:px-4'>
        ...
        transition={{duration:0.5,delay:0.9}}>
            ...
            the <a className='text-textLight bg-bodyColor underline hover:underline-none hover:bg-textLight hover:text-bodyColor' href='https://www.usp.ac.fj/discipline-of-computer-science-and-information-systems/programmes/software-engineering/'>University of the South Pacific!</a> 
        ...
        rounded-md text-textLight tracking-wide hover:bg-textLight hover:drop-shadow-glow 
        ...
        <motion.div
            ...
            transition={{duration:1,delay:0.9}}>
                <Image
                className='mdl:rounded-lg h-full object-cover hover:drop-shadow-glow transition duration-700 ease-in-out'
                src={profileImg}
