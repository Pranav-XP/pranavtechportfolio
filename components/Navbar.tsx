...
const Navbar = () => {
  ...
  return (
    <div className="bg-navbarColor w-full shadow-navbarShadow h-18 sm:h-20 sticky top-0 z-50  px-4">
      <div className=" max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        {/*Small Icon*/}
        <div
          className="hidden w-6 h-5  flex-col justify-between items-center lg:hidden text-4xl 
            text-textLight cursor-pointer overflow-hidden group"
        >
          <span
            className="w-full h-[2px] bg-textLight inline-flex transform 
